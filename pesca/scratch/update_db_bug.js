...
const correctMuro = `// Cargar Mur Públic
...
// Reemplazar loadMuro roto
content = content.replace(/\/\/ Cargar Mur Públic[\s\S]*?\/\/ Cargar Mi Registro/, correctMuro + '\n\n// Cargar Mi Registro');

// Reemplazar loadPersonalRegistro roto
content = content.replace(/\/\/ Cargar Mi Registro[\s\S]*?\/\/ ==============================\n\/\/ FASE 2: CAÑADEX/, correctRegistro + '\n\n// ==============================\n// FASE 2: CAÑADEX');
