...
const playersToAdd = [
    ...
    {name: 'Luka Modric', teams: ['Real Madrid'], aliases: ['modric'], countryCode: 'hr', position: 'MC'},
    {name: 'Brahim Diaz', teams: ['Real Madrid'], aliases: ['brahim'], countryCode: 'ma', position: 'MCO'},
    {name: 'Endrick', teams: ['Real Madrid'], aliases: ['endrick felipe'], countryCode: 'br', position: 'DC'},
    {name: 'Arda Guler', teams: ['Real Madrid'], aliases: ['guler'], countryCode: 'tr', position: 'MCO'},
    ...
    {name: 'Takefusa Kubo', teams: ['Real Sociedad', 'Real Madrid', 'Mallorca'], aliases: ['kubo'], countryCode: 'jp', position: 'ED'},
    ...
    {name: 'Gerard Moreno', teams: ['Villarreal', 'Espanyol'], aliases: ['gerard'], countryCode: 'es', position: 'DC'},
    ...
    {name: 'Vitor Roque', teams: ['Real Betis'], aliases: ['roque'], countryCode: 'br', position: 'DC'},
    ...
    {name: 'Javi Guerra', teams: ['Valencia'], aliases: ['juerra'], countryCode: 'es', position: 'MC'},
    
    // SEVILLA
    {name: 'Jesus Navas', teams: ['Sevilla'], aliases: ['navas'], countryCode: 'es', position: 'LD'},
    {name: 'Isaac Romero', teams: ['Sevilla'], aliases: ['isaac'], countryCode: 'es', position: 'DC'},

    // CELTA VIGO
    {name: 'Fran Beltran', teams: ['Celta Vigo', 'Rayo Vallecano'], aliases: ['beltran'], countryCode: 'es', position: 'MC'},
    {name: 'Iago Aspas', teams: ['Celta Vigo', 'Sevilla'], aliases: ['aspas'], countryCode: 'es', position: 'DC'},
    
    // OSASUNA
    {name: 'Aimar Oroz', teams: ['Osasuna'], aliases: ['aimar'], countryCode: 'es', position: 'MCO'},
    {name: 'Ante Budimir', teams: ['Osasuna', 'Mallorca'], aliases: ['budimir'], countryCode: 'hr', position: 'DC'},

    // ALAVES
    {name: 'Carlos Vicente', teams: ['Alaves'], aliases: ['vicente'], countryCode: 'es', position: 'ED'}
];
...
content = content.replace(/const PLAYERS = \[\r?\n/, `const PLAYERS = [\n${playersStr}`);
content = content.replace(/const PLAYER_PROFILE = \{\r?\n/, `const PLAYER_PROFILE = {\n${profilesStr}`);
content = content.replace(/const COUNTRY_META = \{\r?\n/, `const COUNTRY_META = {\n${countriesStr}`);
