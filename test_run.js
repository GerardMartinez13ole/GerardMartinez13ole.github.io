    ...
    boot();
        ...
        buildIndex();
        console.log("Index built. Team constraints:", state.teamConstraints.length);
        console.log("Total constraints:", state.constraints.length);
        
        // Test generateBoard with 3 countries
        const maxTestAttempts = 200000;
        let found = false;
        let attempts = 0;
        ...
        for(let attempt=0; attempt < 50; attempt++) {
            ...
            try {
               // Temporarily override maxTries inside the function or just copy logic?
               // The function throws if it fails. We'll just catch it.
        ...
        if(!found) console.log("Failed to find board after 50 seeds.");
